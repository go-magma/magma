...
`magma/modules/lte/gateway/deploy/roles/magma/files/systemd/` and are copied into the
...
a service starts.
Note that these files are maintained under `magma/modules/lte/gateway/python/scripts`
