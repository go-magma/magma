...
// If gateway not found by configurator, returns ErrNotFound from "github.com/go-magma/magma/lib/go/errors.
...
// If gateway not registered, returns ErrNotFound from "github.com/go-magma/magma/lib/go/errors.
