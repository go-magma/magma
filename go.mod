module github.com/go-magma/magma

go 1.14

replace github.com/fiorix/go-diameter/v4 => github.com/emakeev/go-diameter/v4 v4.0.6
...
require (
	...
	layeh.com/radius v0.0.0-20200801190433-2801bc3084b7
)
