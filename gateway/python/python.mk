...
protos:: $(BIN)/grpcio-tools $(PROTO_LIST) prometheus_proto platform_proto
...
$(PROTO_LIST): %_protos:
	...
	$(BIN)/python $(SRC)/protos/gen_protos.py $(SRC)/modules/$*/protos/ $(SRC)/modules/$*/protos/,$(MAGMA_ROOT)/protos,$(MAGMA_ROOT)/protos/prometheus,$(MAGMA_ROOT)/modules/lte/protos/ $(SRC) $(PYTHON_BUILD)/gen/

platform_proto:
	@echo "Generating python code for platform .proto files"
	$(BIN)/python $(SRC)/protos/gen_protos.py $(SRC)/protos/ $(MAGMA_ROOT),$(MAGMA_ROOT)/protos/prometheus $(SRC) $(PYTHON_BUILD)/gen/
