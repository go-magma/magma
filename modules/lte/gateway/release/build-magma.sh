...
PY_ORC8R=${MAGMA_ROOT}/gateway/python
...
$(glob_files "${MAGMA_ROOT}/modules/lte/gateway/configs/!(control_proxy.yml|pipelined.yml|sessiond.yml)" /etc/magma/) \
$(glob_files "${MAGMA_ROOT}/modules/lte/gateway/configs/pipelined.yml_prod" /etc/magma/pipelined.yml) \
$(glob_files "${MAGMA_ROOT}/modules/lte/gateway/configs/sessiond.yml_prod" /etc/magma/sessiond.yml) \
$(glob_files "${MAGMA_ROOT}/modules/lte/gateway/configs/templates/*" /etc/magma/templates/) \
$(glob_files "${MAGMA_ROOT}//gateway/configs/templates/*" /etc/magma/templates/) \
