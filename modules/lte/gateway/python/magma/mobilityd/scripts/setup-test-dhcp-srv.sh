...
sleep 1
ip netns exec "$prefix"dhcp_srv  /usr/sbin/dnsmasq -q --conf-file=/home/vagrant/magma/modules/lte/gateway/python/magma/mobilityd/scripts/dnsd.conf  --log-queries --log-facility=/var/log/"$prefix"dnsmasq.test.log &
