...
import (
	...
	"github.com/go-magma/magma/modules/feg/gateway/services/csfb/servicers/decode"
	"github.com/go-magma/magma/modules/feg/gateway/services/csfb/servicers/encode/message"
	"github.com/go-magma/magma/modules/feg/gateway/services/csfb/servicers/mocks"
	"github.com/go-magma/magma/modules/feg/gateway/services/csfb/test_init"
...
func TestCsfbServer_AlertAc(t *testing.T) {
	...
	_, err := client.AlertAc(context.Background(), req)
...
func TestCsfbServer_AlertRej(t *testing.T) {
	...
	client := protos.NewCSFBFedGWServiceClient(conn)
	_, err := client.AlertRej(context.Background(), req)
	assert.NoError(t, err)
...
func TestCsfbServer_EPSDetachInd(t *testing.T) {
	...
	client := protos.NewCSFBFedGWServiceClient(conn)
	_, err := client.EPSDetachInd(context.Background(), req)
	assert.NoError(t, err)
...
func TestCsfbServer_IMSIDetachInd(t *testing.T) {
	...
	client := protos.NewCSFBFedGWServiceClient(conn)
	_, err := client.IMSIDetachInd(context.Background(), req)
	assert.NoError(t, err)
...
func TestCsfbServer_LocationUpdateReq(t *testing.T) {
	...
	client := protos.NewCSFBFedGWServiceClient(conn)
	_, err := client.LocationUpdateReq(context.Background(), req)
	assert.NoError(t, err)
...
func TestCsfbServer_PagingRej(t *testing.T) {
	...
	client := protos.NewCSFBFedGWServiceClient(conn)
	_, err := client.PagingRej(context.Background(), req)
	assert.NoError(t, err)
...
func TestCsfbServer_ServiceReq(t *testing.T) {
	...
	client := protos.NewCSFBFedGWServiceClient(conn)
	_, err := client.ServiceReq(context.Background(), req)
	assert.NoError(t, err)
...
func TestCsfbServer_TMSIReallocationComp(t *testing.T) {
	...
	client := protos.NewCSFBFedGWServiceClient(conn)
	_, err := client.TMSIReallocationComp(context.Background(), req)
	assert.NoError(t, err)
...
func TestCsfbServer_UEActivityInd(t *testing.T) {
	...
	client := protos.NewCSFBFedGWServiceClient(conn)
	_, err := client.UEActivityInd(context.Background(), req)
	assert.NoError(t, err)
...
func TestCsfbServer_UEUnreach(t *testing.T) {
	...
	client := protos.NewCSFBFedGWServiceClient(conn)
	_, err := client.UEUnreach(context.Background(), req)
	assert.NoError(t, err)
...
func TestCsfbServer_Uplink(t *testing.T) {
	...
	client := protos.NewCSFBFedGWServiceClient(conn)
	_, err := client.Uplink(context.Background(), req)
	assert.NoError(t, err)
...
func TestCsfbServer_MMEResetAck(t *testing.T) {
	...
	client := protos.NewCSFBFedGWServiceClient(conn)
	_, err := client.MMEResetAck(context.Background(), req)
	assert.NoError(t, err)
...
func TestCsfbServer_MMEResetIndication(t *testing.T) {
	...
	client := protos.NewCSFBFedGWServiceClient(conn)
	_, err := client.MMEResetIndication(context.Background(), req)
	assert.NoError(t, err)
...
func TestCsfbServer_MMEStatus(t *testing.T) {
	...
	client := protos.NewCSFBFedGWServiceClient(conn)
	_, err := client.MMEStatus(context.Background(), req)
	assert.NoError(t, err)
