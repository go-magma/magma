...
import (
	...
	fegMconfig "github.com/go-magma/magma/gateway/go/mconfig"
	mconfProtos "github.com/go-magma/magma/modules/feg/cloud/go/protos/mconfig"
	utilsDiammeter "github.com/go-magma/magma/modules/feg/gateway/diameter"
...
func GetCsfbConfig() *mconfProtos.CsfbConfig {
	...
	glog.V(2).Infof("Loaded %s configs: %s", CsfbServiceName, config.String())
	return config
}
