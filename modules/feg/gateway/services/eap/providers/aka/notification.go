...
import (
	...
	aaa "github.com/go-magma/magma/modules/feg/gateway/services/aaa/protos"
	"github.com/go-magma/magma/modules/feg/gateway/services/eap"
	"github.com/go-magma/magma/modules/feg/gateway/services/eap/providers/aka/metrics"
...
func Error(code codes.Code, err error) error {
	glog.Errorf("AKA RPC [%s] %s", code, err)
