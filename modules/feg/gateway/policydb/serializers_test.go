...
func TestPolicyDeserializer(t *testing.T) {
	...
	assert.Equal(t, orc8rProtos.TestMarshal(policy), orc8rProtos.TestMarshal(deserializedPolicy))
}
...
func TestNameSetDeserializer(t *testing.T) {
	...
	assert.Equal(t, orc8rProtos.TestMarshal(nameSet), orc8rProtos.TestMarshal(deserializedPolicy))
}
